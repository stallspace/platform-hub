...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0D3B2E] flex items-center justify-center px-4">
      {/* Background grid */}
      <div
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#2ECC8E] hover:bg-[#1a44c2] disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold rounded-lg px-4 py-3 text-sm transition-all"
            >
              {loading ? (
        ...
        <p className="text-center text-white/20 text-xs mt-6">
          Stallspace © {new Date().getFullYear()} · Restricted Access
        </p>
      </div>
    </div>
  )
