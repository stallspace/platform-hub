      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="flex items-center gap-1.5 text-sm text-gray-400">
            ...
            <Link href="/marketplace/vendors" className="hover:text-brand-accent transition-colors">Vendors</Link>
            <ChevronRight className="w-3.5 h-3.5" />
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <h3 className="font-medium text-gray-900 line-clamp-2 text-sm group-hover:text-brand-accent transition-colors">
                          {product.name}
                        </h3>
