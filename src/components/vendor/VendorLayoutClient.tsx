...
export default function VendorLayoutClient({ vendor, children }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAF3] flex">
      ...
      {/* ── Sidebar ── */}
      <aside className="w-64 bg-[#0D3B2E] flex-shrink-0 flex flex-col">
        ...
        <div className="p-5 border-b border-white/10">
          ...
          <p className="text-white/40 text-xs mt-1.5 font-medium uppercase tracking-wider">Vendor Portal</p>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white border-b border-[#E5E7EB] px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-8 h-8 bg-[#0D3B2E] rounded-full flex items-center justify-center text-white text-sm font-bold">
              {initials}
            </div>
          </div>
        </header>
